create table Salesman2_master(
    SelesmanNo varchar(20) primary key,
    CName varchar(20),
    Address1 varchar(20),
    Address2 varchar(20),
    City varchar(10),
...
insert into Salesman2_master (SelesmanNo,CName,Address1,Address2,City, Pincode,Cstate) values
